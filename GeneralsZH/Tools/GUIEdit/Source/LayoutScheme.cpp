...
void LayoutScheme::applyPropertyTablesToWindow( GameWindow *root )
{
	...
	if( OHBitTest( root->winGetStyle(), GWS_PUSH_BUTTON ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_RADIO_BUTTON ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_CHECK_BOX ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_VERT_SLIDER ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_HORZ_SLIDER ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_SCROLL_LISTBOX ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_COMBO_BOX ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_ENTRY_FIELD ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_STATIC_TEXT ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_PROGRESS_BAR ) )
	{
	...
	else if( OHBitTest( root->winGetStyle(), GWS_TAB_CONTROL ) )
	{
