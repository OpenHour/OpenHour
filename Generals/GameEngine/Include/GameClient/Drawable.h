...
public:
	...
	Bool testTintStatus( TintStatus statusBits ) const { return OH_BitTest( m_tintStatus, statusBits ); };
	...
	Bool getShadowsEnabled() const { return OH_BitTest(m_status, DRAWABLE_STATUS_SHADOWS); }
	...
	Bool getDrawsInMirror() const { return OH_BitTest(m_status, DRAWABLE_STATUS_DRAWS_IN_MIRROR) || isKindOf(KINDOF_CAN_CAST_REFLECTIONS); }
